        ...
        child: SingleChildScrollView(
          child: Column(
            ...
            children: <Widget>[
              ...
              SizedBox(height: 48),
              _buildNavigationOption("Acceuil", Icons.home, onTap: () {
                this.onTap(0);
              }),
              _buildNavigationOption("Apropos", Icons.account_box, onTap: () {
                this.onTap(1);
              }),
              _buildNavigationOption("Compétences", Icons.book, onTap: () {
                this.onTap(2);
              }),

              _buildNavigationOption("Experiences", Icons.work, onTap: () {
                this.onTap(3);
              }),
